...
import {addOutline, closeOutline, createOutline, moveOutline, trashOutline} from "ionicons/icons";
...
export const ObjectActionsFooter: React.FC = (
    {hasModifyButton, setFooter, mainScene, upgradeDetails, showErrorMessage}:
        {
    ...
    return (
        <>
            {
                hasModifyButton ?
                    <IonButton style={{margin: "5px", fontSize: "20px", opacity: 1}} shape="round" color="tertiary"
                               onClick={() => mainScene.modifySelectedItem()}>
